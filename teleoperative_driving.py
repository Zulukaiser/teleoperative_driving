...
class Ui_window_title(object):
    def setupUi(self, window_title):
        ...
        self.connection_status.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.NoContextMenu)
        ...
        self.connection_status.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.NoTextInteraction)
        ...
        self.steering_wheel.setStyleSheet("background-color: rgb(255, 255, 255);\nimage: url(:/steering_wheel/steering_wheel.png);")
        ...
        self.steering_wheel_angle_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.gas_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gas_label_2.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.latency_one_way_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.latency_two_way_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        for item in parts:
            try:
                if not 0 <= int(item) <= 255:
                    if log:
                        self.log_console.append(f"Invalid IP: {item} not in range(0,255)")
                    return False
    ...
    def retranslateUi(self, window_title):
        ...
        self.establish_connection.setText(_translate("window_title", "Establish Connection"))
        ...
        self.connection_status.setText(_translate("window_title", "<html><head/><body><p>Connection Status</p></body></html>"))
        ...
        self.latency_one_way_label.setText(_translate("window_title", "Latency 1-way [ms]:"))
        self.latency_two_way_label.setText(_translate("window_title", "Latency 2-way [ms]:"))
        self.velocity_label.setText(_translate("window_title", "Velocity [km/h]:"))
        self.menuTeleoperative_Driving.setTitle(_translate("window_title", "Teleoperative Driving"))
    ...
    def convert_cv_qt(self, cv_img):
        ...
        p = convert_to_Qt_format.scaled(self.display_width, self.display_height, aspectRatioMode=Qt.AspectRatioMode.KeepAspectRatio)
    ...
    def handle_controller(self, controller_data: dict):
        ...
        self.gas_value.setText(str(controller_data["RT"]*100.))
        self.brake_value.setText(str(controller_data["LT"]*100.0))
        self.steering_wheel_angle.setText(str(controller_data["LJoyX"]*controller_data["LJoyX"]*90.0))
